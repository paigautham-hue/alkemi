...
export function getSessionCookieOptions(
  ...
  // For production (HTTPS), use none to support OAuth redirects
  ...
  return {
    ...
    path: "/",
    sameSite,
    // Always set secure:true for sameSite:none (required by browsers)
    // For local dev with sameSite:lax, secure can be false
