...
export async function createMaterial(material: InsertMaterial) {
  ...
  await db.insert(materials).values({
    ...
    hansenR0: (material as any).hansenR0 || null,
    // Materials v2
    materialFunction: (material as any).materialFunction || null,
    subFunction: (material as any).subFunction || null,
    solidsContent: (material as any).solidsContent || null,
    vocContent: (material as any).vocContent || null,
    functionality: (material as any).functionality || null,
    equivalentWeight: (material as any).equivalentWeight || null,
    particleSizeD50: (material as any).particleSizeD50 || null,
    oilAbsorption: (material as any).oilAbsorption || null,
    hlb: (material as any).hlb || null,
    surfaceTension: (material as any).surfaceTension || null,
    molarVolume: (material as any).molarVolume || null,
    smiles: (material as any).smiles || null,
    inchiKey: (material as any).inchiKey || null,
    pubchemCid: (material as any).pubchemCid || null,
